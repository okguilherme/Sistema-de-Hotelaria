 ...
 * 
 * import src.main.src.model.Quarto;
 * import src.main.src.model.Reserva;
 * 
 ...
 * if (quarto == null) {
 * System.out.println("Erro: Quarto " + reserva.getNumeroQuarto() +
 * " não encontrado.");
 * return null;
 * }
 ...
 * 
 * System.out.println("Reserva " + idGerado + " para o quarto " +
 * quarto.getNumero() + " realizada com sucesso.");
 * return reserva;
 * }
 * 
 ...
 * servicoQuarto.atualizarDisponibilidadeQuarto(reservaRemovida.getNumeroQuarto(
 * ), true);
 * System.out.println("Reserva " + idReserva + " cancelada com sucesso.");
 * return true;
 * }
 * System.out.println("Erro: Reserva com ID " + idReserva +
 * " não encontrada para cancelamento.");
 * return false;
 * }
 * 
